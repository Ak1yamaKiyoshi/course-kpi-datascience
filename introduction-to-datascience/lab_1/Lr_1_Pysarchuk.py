...
if __name__ == '__main__':
    ...
    # ------------------------------ сегмент констант ---------------------------------------
    n = 10000                       # кількість реалізацій ВВ - об'єм вибірки Випадкові величини 
    iter = int(n)
    Q_AV = 3                        # коефіцієнт переваги АВ - Аномальні виміри 
    nAVv = 10
    nAV = int((iter * nAVv) / 100)  # кількість АВ у відсотках та абсолютних одиницях
    dm = 0
    dsig = 5                        # параметри нормального закону розподілу ВВ: середнє та СКВ # Середньоквадратичне відхилення
