...
# Варіант 2
# Алгоритм виявлення аномальних вимірів: За коефіцієнтом старіння інформації
anomalies_detected_var2 = detect_anomalies_decay(measurements)
# Метод усунення впливу аномальних вимірів: Відкидання вимірів
cleaned_data_var2 = reject_anomalies(measurements, anomalies_detected_var2)
# Монте-Карло аналіз
monte_carlo_results_var2 = monte_carlo_analysis(measurements, anomalies_detected_var2)

# Відображення результатів для варіанту 1
#display_results(ideal_values, measurements, measurements, smoothed_data_var1,
#    monte_carlo_results_var1['errors_noisy'], monte_carlo_results_var1['errors_anomalous'], monte_carlo_results_var1['errors_smoothed'])

# Відображення результатів для варіанту 2
display_results(ideal_values, measurements, cleaned_data_var2, cleaned_data_var2,
    monte_carlo_results_var2['errors_noisy'], monte_carlo_results_var2['errors_anomalous'], monte_carlo_results_var2['errors_smoothed'])